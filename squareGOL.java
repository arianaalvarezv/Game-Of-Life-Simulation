/*
	...
	Part 1: Warmup. Square Game of Life
*/
...
public class squareGOL {
	...
	public static int[][] getNeighs(boolean[][] alive, int i, int j) {
		// This retrieves the x,y coordinates of the 8 neighbors

		int [][] coordi =  { {i-1, j-1}, {i, j-1}, {i+1, j-1},
		 					 {i-1, j}, /*{i, j}, */{i+1, j},
	...
	public static void main(String[] args) {
		...
		//System.out.println(getNeighs(alive,2,2));
		//System.out.println(countAliveNeighs(alive,2,2));
